                      ...
                      <div class="card-body">
                          ...
                          @csrf
                            ...
                            <div id="bb" class="form-group row">
                              ...
                              <div class="col-sm-9">
                                <input type="text" class="form-control @error ('nim') is-invalid @enderror" id="nim" placeholder="Isi NIM/NIP" name="nim" value="{{ old('nim') }}">
                                  @error ('nim')
                                  <div class="invalid-feedback">
                                      {{ $message }}
                                  </div>
                            ...
                            <div id="ee" class="form-group row">
                              ...
                              <div class="col-sm-9">
                                <input type="date" class="form-control @error ('tgl') is-invalid @enderror" id="tgl" placeholder="Isi Tanggal Lahir" name="tgl" value="{{ old('tgl') }}">
                                  @error ('tgl')
                                  <div class="invalid-feedback">
                                      {{ $message }}
                                  </div>
